...
class ProductControllerV1 extends AbstractController
{
    ...
    public function showV2(Product $product): Response
    {
        ...
        return new Response(
            'Check out this great product: ' . $product->getName()
        );
    }
    ...
    public function show(int $id): Response
    {
        ...
        //http://localhost/symfony/public/product/2
    ...
    public function update(int $id): Response
    {
        ...
        // http://localhost/symfony/public/product/edit/3
    ...
    {
        // DANS LE NAVIGATEUR, ON DEMANDE CETTE URL
        // http://localhost/symfony/public/product/delete/2
        // DANS SYMFONY, ON A UNE ROUTE PARAMETREE
